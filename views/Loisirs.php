...
<body>
	...
	<div id="article">
    <h1 class='page_title'>Ce que j'apprécie dans...<div class="fil"><?= $fil ?></div></h1>
    <div class="contenu">
      ...
      Je trouve aussi très beau les communautés qui se développent autour des jeux.<br>
  		Aujourd'hui, je souhaite non plus uniquement me divertir avec des jeux vidéos, je veux comprendre comment ils fonctionnent et je veux moi aussi être capable d'en faire.

  		<h2>Le travail de groupe</h2>
  		Même si je fais des efforts, je reste quelqu'un de réservé. Mais pourtant, j'aime beaucoup le travail de groupe car il permet l'entraide et donne la motivation de faire de son mieux pour les autres. Il crée un vrai esprit d'équipe et donne une réelle impression de faire quelque chose d'utile, qui sert à quelqu'un.
